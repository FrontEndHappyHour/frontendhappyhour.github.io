...
module.exports = function() {
  ...
  <p><strong>Anne Ricketts</strong>  On Zoom they have polls. And I know on Google Hangouts, I think you can use something called Slido or Kahoot. There's different there's different tools that you can use. But just, you know, is it A, is it B, is it C? And then the other thing is then you can have them say, OK, I want to know a little bit more about that, go into chat. And in one sentence or less, tell me why you answered the way you did. And then if you have a moderator, they can start to call out some of the answers. People love to hear their names. You can say, oh, ma said this. Jem said this. So just this is really can be a fun way to get people engaged. 
