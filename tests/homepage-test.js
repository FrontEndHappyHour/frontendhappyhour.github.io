...
const expected = `<!DOCTYPE html>
          <html>
              <head>
                  ...
                  <meta name="description" content="A podcast featuring panelists of engineers from Netflix, Evernote & LinkedIn talking over drinks about all things Front End development.">
            ...
            <div class="container">
                ...
                <div class="right-content">
                    ...
                    <p class="tagline">A podcast featuring panelists of engineers from Netflix, Evernote & LinkedIn talking over drinks about all things Front End development.</p>
                    <ul class="feeds">
