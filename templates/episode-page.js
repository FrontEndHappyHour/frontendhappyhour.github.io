...
module.exports = function episodePage(epDate, id, vidID, epDesc) {
  ...
  if (vidID !== null && vidID !== '' && vidID !== undefined) {
    videoContent = `<div class="audio"><iframe src="https://www.youtube.com/embed/${vidID}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>`;
  }
